...
= 1.1.11 =
* Fixed hamburger overlay staying white in dark mode (native overlay colors + high-specificity modal-open CSS)
* Fixed post titles, site titles, query titles, and headings staying black in dark mode

= 1.1.10 =
* Fixed block editor body text invisible when OS is in dark mode (editor canvas stays light with dark text)
* Fixed hamburger/overlay navigation menu white-on-white text in dark mode (dark background + light text)
